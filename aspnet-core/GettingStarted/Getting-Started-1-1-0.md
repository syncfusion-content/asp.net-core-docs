...
description: Learn here all about getting started with Syncfusion ASP.NET Core Application(Common) control,its elements and more.
...
*  Open Visual Studio 2015 to create **ASP.NET Core web application**.
   ...
   ![Configure Syncfusion UI Components in ASP.NET Core Application](getting-started_images/getting-started_img1.png)

*  After project creation, open your **project.json** file to add our Syncfusion assembly packages.

   ![Open Project.json file to add Syncfusion assembly packages in ASP.NET Core Application](getting-started_images/getting-started_img5.png)
...
*  In the Solution Explorer window, click the **"Show All Files"** button.
   ...
   ![Click the show all file button in ASP.NET Core Application](getting-started_images/getting-started_img6.jpeg)
   
*  Open **bower.json** file to include the following necessary packages.   

   ![Open bower.json file in ASP.NET Core Application](getting-started_images/getting-started_img2.png)

*  After Bower packages installation the scripts and CSS files are loaded into the **wwwroot -> lib** folder as shown below

   ![After bower packages installation the script and CSS file are loaded in ASP.NET Core Application](getting-started_images/getting-started_img3.png)
...
* Open Visual Studio 2015 to create **ASP.NET Core web application**.
   ...
   ![Configure Syncfusion UI Components in ASP.NET Core Application](getting-started_images/getting-started_fileformat_img1.png)

* After project creation, open your **project.json** file to add our Syncfusion assembly packages.

   ![Open bower.json file in ASP.NET Core Application](getting-started_images/getting-started_fileformat_img2.png)
...
{% endhighlight %}
  ...
  ![Create new web application in ASP.NET Core Application](getting-started_images/getting-started_img10.JPG)
...
* Open Visual Studio Code and open your ASP.NET folder using **Open -> Folder** menu. Now your project folder is loaded in Visual Studio Code application.
  ...
  ![Use open folder menu in ASP.NET Core Application](getting-started_images/getting-started_img11.JPG)
...
* Open your **bower.json** json file and specify our Syncfusion package will loads our scripts and CSS. Refer this [link](https://help.syncfusion.com/js/installation-and-deployment#configuring-syncfusion-bower-packages) to configure the bower execution environment in your local machine. Then install a bower extension in your Visual Studio code to complete a configuration.    
  ...
  ![Install bower extension in ASP.NET Core Application](getting-started_images/getting-started_img12.JPG)


* In **bower.json** file specify our Syncfusion packages with our latest version.

  ![Bower.json file specify Syncfution packages with latest version in ASP.NET Core Application](getting-started_images/getting-started_img13.JPG)
...
* Open quick window (Ctrl + p) to run the `bower install` command to install our scripts and CSS to your application **wwwroot -> lib** folder.
  ...
  ![Bower command to install scripts and CSS to the application in ASP.NET Core Application](getting-started_images/getting-started_img14.JPG)
...
* Now open your **project.json** file to specify our assembly packages.
  ...
  ![Open project.json file to specify assembly packages in ASP.NET Core Application](getting-started_images/getting-started_img15.JPG)
...
{% endhighlight %}
  ...
  ![Restore the packages specifying project.json file in ASP.NET Core Application](getting-started_images/getting-started_img16.JPG)
...
* Finally press F5 key to deploy your project.
  ...
  ![Deploy the project in ASP.NET Core Application](getting-started_images/getting-started_img17.JPG)
...
{% endhighlight %}
  ...
  ![Yeoman generator installed successfully in ASP.NET Core Application](getting-started_images/getting-started_img7.JPG)
...
* From the list of available projects, select the **Web Application Basic [ without Membership and Authorization ]** by using arrow keys.
  ...
  ![Web Application Basic Using Arrow Key in ASP.NET Core Application](getting-started_images/getting-started_img8.JPG)


* And then provide the project name or simply press the enter key to create the project with default name.

  ![Provide the project name in ASP.NET Core Application](getting-started_images/getting-started_img9.JPG)
...
* Open Visual Studio Code and open your ASP.NET folder using **Open -> Folder** menu. Now your project folder is loaded in Visual Studio Code application.
  ...
  ![Open Visual Studio Code in ASP.NET Core Application](getting-started_images/getting-started_img11.JPG)
...
* Open quick window (Ctrl + p) to run the `bower install` command to install our scripts and CSS to your application **wwwroot -> lib** folder.
  ...
  ![Bower command to install scripts and CSS in ASP.NET Core Application](getting-started_images/getting-started_img14.JPG)
