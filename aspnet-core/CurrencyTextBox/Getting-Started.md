...
## Create your first CurrencyTextBox in ASP.NET Core
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>                        
                        ...
                        <ej-currency-text-box id="currency" watermark-text="Amount per unit" min-value="0.00" max-value="100000.00" value="350.00" decimal-places="2" enable-strict-mode="true" />
