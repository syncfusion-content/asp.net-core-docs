---
layout: post
title: EJTagHelpers in ASP.NET Core Common Control | Syncfusion
description: Learn here all about EJTagHelpers support in Syncfusion Essential ASP.NEt Core Common control, its elements, and more. 
platform: js
...
# TagHelpers in ASP.NET Core Common
...
![ASP.NET Core Common API configuration with tag helpers](ej-tag-helpers_images/ej-tag-helper_image.png)   
