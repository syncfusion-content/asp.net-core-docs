...
* \#F141291 - Filtering and sorting operations works properly when paging option in member editor dialog is enabled.

* \#F141274 - While changing the number format, value filtering works properly in advanced filter module.
## Presentation
