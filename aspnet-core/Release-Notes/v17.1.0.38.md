...
* \#218557 - Resolved the issue “empty file creation when exporting the report from core application with the .NET Framework using NuGet”.
* \#F142716 - NRE raises when Nothing is specified as scope for `RunningValue` aggregate issue has been resolved.
* \#231384 - External images not rendering in Report Viewer issue has been resolved.
## Spreadsheet
