...
* Provided the support for .NET Core 3.1 and .NET 5.0 compatibility.
## DocIO
...
* \#198534, I258701 – Added support for compressing existing PDF documents.
* \#262320 – Added support for replace image in an existing PDF document.
...
* \#277206 – Images will be rotated properly when converting Word to PDF document.
## Presentation
