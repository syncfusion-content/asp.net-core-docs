...
* \#245754 - Added support for DataTable as data source to PDF Grid and Light table.
* \#240259, 240461 - Added support for exporting PdfBarcode to Image in .NET Core. 
* Added support for converting XPS to PDF in .NET Core. 
...
* \#238012 - `OriginalFontName` property in `SubstituteFontEventArgs` class gets the original font name.
* \#238012 - `AlternateFontName` property in `SubstituteFontEventArgs` class gets or sets the alternate font name.
* \#238012 - `SubstituteFontEventArgs` event class is implemented in `ApplicationImpl` class to substitute alternate fonts during Excel to PDF or Image conversion.
* \#238012 - `SubstituteFontEventHandler()` delegate in `ApplicationImpl` class represents the method that handles substitute font event.
* \#238012 - `SubstituteFont` event is added in `IApplication` interface and `ApplicationImpl` class to substitute an alternate font in Excel to PDF/Image conversion.
...
* \#247352, \#248207, \#248316 - Exception is no longer thrown while opening the Excel file in multi-threading environment.
...
* \#242913 - Font name and font size are no longer changed while opening the Excel document.
