...
* \#236676 - The issue “Cell border not rendered properly for merged cells when exporting report to Excel format from Report Server” has been resolved.
* \#237449 - The issue “SSRS report gets empty stream when exporting in ASP.NET Core Report Writer application” has been resolved.
* The issue “Bar code report rendered with #Error in the PPT exported document” has been resolved.
## XlsIO
