...
* \#250760 - Contents are now preserved properly when open and save the RTF format Word document.
...
* \#F148572 - File size is reduced while converting Excel document with images to PDF. 
