...
* \#257391 - Focus navigations of parent row to child grid row works properly when we press for tab key.
## PDF

### Features
{:#PDF-Features}

* \#F148653, \#244900, \#257701, \#260693, \#263510, \#264407, \#263493 – Added support for HTML to PDF conversion using Blink in `.NET Core`. 
* \#181414, \#177819, \#239109, \#201866, \#250807, \#251752, \#255812, \#255798, \#F150821 – Added support for OCR processor in `.NET Core`. 
...
* \#266511 - Images will be extracted properly from existing PDF document.
* \#F151495 - Hanging issue no longer occurs while signing PDF document with timestamp server. 
...
* \#F149959 – ArgumentOutOfRange exception is no longer thrown while opening Excel file in Ubuntu.
