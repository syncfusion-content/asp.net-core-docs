...
The steps below show how to install Essential Studio ASP.NET Core Web Installer.
...
Syncfusion ASP.NET Core installer can be uninstalled in two ways.

   * Uninstall the ASP.NET Core using the Syncfusion ASP.NET Core web installer
   * Uninstall the ASP.NET Core from Windows Control Panel

Follow either one of the option below to uninstall Syncfusion Essential Studio ASP.NET Core installer.
