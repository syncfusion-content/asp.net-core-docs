...
1. Create Syncfusion ASP.NET core Application. You can refer the [ASP.NET core Getting Started documentation](https://help.syncfusion.com/aspnet-core/getting-started)to create new project and add necessary DLL’s and script files.
