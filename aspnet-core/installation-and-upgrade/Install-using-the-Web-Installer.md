...
The following procedure illustrates how to install Essential Studio ASP.NET Core Online Installer setup. 

1.  Double-click the Syncfusion Essential Studio ASP.NET Core Online Installer setup file. The Setup Wizard opens and extracts the package automatically.
...
2. Welcome wizard of the Syncfusion ASP.NET Core Online Installer will be displayed. Click Next.
...
The following procedure illustrates how to uninstall Essential Studio ASP.NET Core from Web Installer setup. 
...
The following procedure illustrates how to install/uninstall Essential Studio ASP.NET Core from Web Installer setup. 
