...
The following procedure illustrates how to install Essential Studio for ASP.NET Core Online Installer. 

1.  Double-click the Syncfusion ASP.NET Core Online Installer setup file. The Setup Wizard opens and extracts the package automatically.
