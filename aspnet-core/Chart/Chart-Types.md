...
description: Learn here all about what the different types of charts available in Essential JavaScript Chart are and much more.
...
![the line segment color.](Chart-Types_images/Chart-Types_img1.png)
...
![the width property of the series.](Chart-Types_images/Chart-Types_img2.png)
...
![the dash array option of the series.](Chart-Types_images/Chart-Types_img3.png)
...
![ the line cap property.](Chart-Types_images/Chart-Types_img4.png)
...
![the line join property.](Chart-Types_images/Chart-Types_img5.png)
...
![multi color line.](Chart-Types_images/Chart-Types_img81.png)
...
![step line chart.](Chart-Types_images/Chart-Types_img6.png)
...
![ change the line width.](Chart-Types_images/Chart-Types_img7.png)
...
![the step line series with dotted lines.](Chart-Types_images/Chart-Types_img8.png)
...
![changing the line cap.](Chart-Types_images/Chart-Types_img9.png)
...
![changing the line join.](Chart-Types_images/Chart-Types_img10.png)
...
![area in the chart series.](Chart-Types_images/Chart-Types_img11.png)
...
![range area in the chart series.](Chart-Types_images/Chart-Types_img12.png)
...
![step area in the chart series.](Chart-Types_images/Chart-Types_img13.png)
...
![spline area in the chart series.](Chart-Types_images/Chart-Types_img14.png)
...
![stacking area in the chart series.](Chart-Types_images/Chart-Types_img15.png)
...
![stacking area100 in the chart series.](Chart-Types_images/Chart-Types_img16.png)
...
![stacking spline area in the chart series.](Chart-Types_images/Chart-Types_img97.png)
...
![stacking spline area100 in the chart series.](Chart-Types_images/Chart-Types_img98.png)
...
![column in the chart series.](Chart-Types_images/Chart-Types_img17.png)
...
![change the color of a column.](Chart-Types_images/Chart-Types_img18.png)
...
![column width customization.](Chart-Types_images/Chart-Types_img88.png)
...
![the corner radius property.](Chart-Types_images/Chart-Types_img90.png)   
...
![the column spacing property.](Chart-Types_images/Chart-Types_img89.png)
...
![set the column facet property.](Chart-Types_images/Chart-Types_img91.png)
...
![range column in the chart series.](Chart-Types_images/Chart-Types_img19.png)
...
![the fill property of point.](Chart-Types_images/Chart-Types_img20.png)
...
![to stacking column in the chart series.](Chart-Types_images/Chart-Types_img21.png)
...
![stacking group property to group the stacked columns.](Chart-Types_images/Chart-Types_img22.png)
...
![the fill property of the point.](Chart-Types_images/Chart-Types_img23.png)
...
![stacking column100 in the chart series.](Chart-Types_images/Chart-Types_img24.png)
...
![the stacking group property.](Chart-Types_images/Chart-Types_img25.png)
...
![the color of a 100% stacking column.](Chart-Types_images/Chart-Types_img26.png)
...
![set the type to bar in the chart series.](Chart-Types_images/Chart-Types_img27.png)
...
![change the color of a bar.](Chart-Types_images/Chart-Types_img28.png)
...
![stacking bar in the chart series.](Chart-Types_images/Chart-Types_img29.png)
...
![the stacking group property to group the stacking bars.](Chart-Types_images/Chart-Types_img30.png)
...
![the color of a stacking bar by using the fill property of the point.](Chart-Types_images/Chart-Types_img31.png)
...
![set the type to stacking bar100 in the chart series.](Chart-Types_images/Chart-Types_img32.png)
...
![chart - change the color.](Chart-Types_images/Chart-Types_img34.png)
...
![set the type to spline in the chart series.](Chart-Types_images/Chart-Types_img35.png)
...
![the spline type property in the series.](Chart-Types_images/Chart-Types_img36.png)
...
![the dash array option of the series.](Chart-Types_images/Chart-Types_img37.png)
...
![the series type to pie in the chart series.](Chart-Types_images/Chart-Types_img38.png)
...
![the pie co efficient property.](Chart-Types_images/Chart-Types_img39.png)
...
![the explode index property of the series.](Chart-Types_images/Chart-Types_img40.png)
...
![the explode all property.](Chart-Types_images/Chart-Types_img41.png)
...
![to explode a pie segment by hovering the mouse.](Chart-Types_images/Chart-Types_img42.png)
...
![the start angle and end angle options.](Chart-Types_images/Chart-Types_img43.png)
...
![to doughnut in the chart series.](Chart-Types_images/Chart-Types_img44.png)
...
![the doughnut coefficient with respect to the plot area.](Chart-Types_images/Chart-Types_img45.png)
...
![change the doughnut size.](Chart-Types_images/Chart-Types_img46.png)
...
![to explode a specific doughnut segment.](Chart-Types_images/Chart-Types_img47.png)
...
![enable the explode all property of the series.](Chart-Types_images/Chart-Types_img48.png)
...
![to explode a doughnut segment by hovering the mouse.](Chart-Types_images/Chart-Types_img49.png)
...
![the start angle and end angle options.](Chart-Types_images/Chart-Types_img50.png)
...
![multiple pie chart.](Chart-Types_images/Chart-Types_img82.png)
...
![start and end angles support](Chart-Types_images/Chart-Types_img84.png)


**Sector of multiple doughnut**

![sector of multiple doughnut](Chart-Types_images/Chart-Types_img85.png)
...
![to pyramid in the chart series.](Chart-Types_images/Chart-Types_img51.png)
...
![linear pyramid mode in chart series.](Chart-Types_images/Chart-Types_img52.png)
...
![the gap ratio property of the series.](Chart-Types_images/Chart-Types_img53.png)
...
![explode a pyramid segment in chart series.](Chart-Types_images/Chart-Types_img54.png)
...
![funnel in the chart series.](Chart-Types_images/Chart-Types_img55.png)
...
![the chart size by using the funnel height and funnel width properties of the series.](Chart-Types_images/Chart-Types_img56.png)
...
![explode a funnel segment on the chart load.](Chart-Types_images/Chart-Types_img57.png)
...
![to bubble in the chart series.](Chart-Types_images/Chart-Types_img58.png)
...
![the series type to scatter in the chart series.](Chart-Types_images/Chart-Types_img59.png)
...
![customize the scatter chart.](Chart-Types_images/Chart-Types_img60.png)
...
![to hilo open close in the chart series.](Chart-Types_images/Chart-Types_img61.png)
...
![draw mode option in chart type.](Chart-Types_images/Chart-Types_img62.png)
...
![bull and bear color in chart type.](Chart-Types_images/Chart-Types_img63.png)
...
![ the series type to candle in the chart series.](Chart-Types_images/Chart-Types_img64.png)
...
![bull and bear color in chart type.](Chart-Types_images/Chart-Types_img65.png)
...
![to hilo in the chart series.](Chart-Types_images/Chart-Types_img66.png)
...
![to polar in the chart series.](Chart-Types_images/Chart-Types_img67.png)
...
![draw type is line in chart series.](Chart-Types_images/Chart-Types_img68.png)
...
![stack columns in polar chart in chart series.](Chart-Types_images/Chart-Types_img69.png)
...
![to radar in the chart series.](Chart-Types_images/Chart-Types_img70.png)
...
![draw type is line in chart serise.](Chart-Types_images/Chart-Types_img71.png)
...
![stack columns in radar chart in chart series.](Chart-Types_images/Chart-Types_img72.png)
...
![to waterfall in the chart series.](Chart-Types_images/Chart-Types_img73.png)
...
![show intermediate sum in chart serise.](Chart-Types_images/Chart-Types_img74.png)
...
![connectorLine option of series.](Chart-Types_images/Chart-Types_img75.png)
...
![to error bar in the series.](Chart-Types_images/Chart-Types_img76.png)
...
![customize the error bar type in chart series.](Chart-Types_images/Chart-Types_img77.png)
...
![changing error bar mode in chart series.](Chart-Types_images/Chart-Types_img78.png)
...
![change the error bar direction in chart series.](Chart-Types_images/Chart-Types_img79.png)
...
![customizing error bar cap in chart series.](Chart-Types_images/Chart-Types_img80.png)
...
![customize the outlier.](Chart-Types_images/Chart-Types_img92.png)
...
![the pie of pie chart.](Chart-Types_images/Chart-Types_img93.png)
...
![split mode and split value.](Chart-Types_images/Chart-Types_img94.png)
...
![pie of pie coefficient property.](Chart-Types_images/Chart-Types_img95.png)
...
![customizing the gap.](Chart-Types_images/Chart-Types_img96.png)
