        ...
        <e-circular-scale-collections>
            <e-circular-scales show-ranges="true"
               ...
               <e-custom-label-collections>
                    <e-circular-custom-labels color="white"></e-circular-custom-labels>
               </e-custom-label-collections>
...
<ej-circular-gauge id="circulargauge"
        ...
        <e-circular-scale-collections>
            <e-circular-scales show-ranges="true" show-indicators="true">
                <e-circular-range-collections>
                    <e-circular-ranges start-value="0" end-value="70" distance-from-scale="30" background-color="#5DF243">
                        <e-border color="#FFFFFF"></e-border>
                    </e-circular-ranges>
                    <e-circular-ranges start-value="70" end-value="140" distance-from-scale="10" background-color="#F6FF0A">
                        <e-border color="#FFFFFF"></e-border>
                    </e-circular-ranges>
                    <e-circular-ranges start-value="140" end-value="200" distance-from-scale="-30" background-color="#FF1807">
                        <e-border color="#FFFFFF"></e-border>
                    </e-circular-ranges>
                </e-circular-range-collections>
